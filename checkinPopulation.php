...
//public $sql="SELECT * FROM welcome_week_signup WHERE residence=? && time_of_swipe >=?&&time_of_swipe<?";
    ...
    public $sql_count_University_Housing_Total_CheckinsBy_GROUP_AREA = "SELECT residence_campus_area,count(residence_campus_area) FROM welcome_week_signup GROUP BY(residence_campus_area) ";
    ...
    public function getSQLNeededForUniversityHousing_GroupCounts()
    {
        return $this->sql_count_University_Housing_Total_CheckinsBy_GROUP_AREA;
    }
