...
<tbody>    
    ...
    //Get the residence hall name (Grouped by Hall or AFC - A, B, C === Avent Ferry//
    //Not needed as we are utilized the centralized campus area and not a particular residence.
    //$residenceNAME=$_GET["residence"];
    
    //Get the centralized location//
    ...
    //$dateNEEDED=$_GET["dateNEEDED"];
                        //Set Residence Hall
                        //4-16-2015 -- not needed as we are looking for centralized areas and not residence names.
                        ...
                        for($x=$beginTIMEBEGIN;$x<$endTIMESTOP;$x++){
                          ...
                          //Close the cell off, use a new report generation -- "endcell_forreportgeneration_campus_area" as we
                          //need to look for central campus area, not neceassarily residences.  
                         include('endcell_forreportgeneration_campus_area.php');
