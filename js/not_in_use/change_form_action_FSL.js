...
// Function to change form action.
    $('#student_missing_in_system').change(function() {
        ...
        if (this.checked) {
            ...
            $("#check_in_form_students").attr('action', '../processing/checkin-manual_student-done.php');			//have to go back a directory because this is being loaded from FSL/index.php.
        }
        //If the add new student checkbox is not checked, must go to the regular check-in done page.
            ...
            $("#check_in_form_students").attr('action', '../processing/checkin-done.php');							//have to go back a directory because this is being loaded from FSL/index.php.
