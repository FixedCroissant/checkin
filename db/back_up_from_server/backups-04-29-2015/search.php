...
//Create a roommate object
 ...
 //ID we're looking for ....
    ...
    //Execute the query.
     ...
     while($rowUNITNEEDED = oci_fetch_array($statementFORUNIT,OCI_ASSOC)){
		 ...
		 //Commented out on 04-23-2015
         //echo "This is the effective term:".$rowUNITNEEDED["EFFECTIVE_TERM"]."This is the building:".$rowUNITNEEDED["BUILDING"]."This is the unit number".$rowUNITNEEDED["NC_HIS_UNIT_NUM"]."This is the unit suffix number".$rowUNITNEEDED["NC_HIS_UNIT_SUFFIX"]; 
 ...
 //echo $givenUNITNUMBER; 
    ...
    //04-23-2015 -- Fall 2015 doesn't appear to provide any students.
	//Using Spring 2015 TERM: 2151 to provide student information for the time being.
