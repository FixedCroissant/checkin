...
//{
    ...
    $query="SELECT * FROM PS_NC_HIS_PPE_VW WHERE NC_FIRST_NAME_PRI LIKE :fname";
    ...
    oci_bind_by_name($statement,':fname',$first_name);
     ...
     echo "<div id=search_result_details class=results>";
                while($row = oci_fetch_array($statement,OCI_ASSOC)){
                    ...
                    echo "<br/>";
                    echo "FIRST:"."<span id=first_name_needed style='margin-left:70px; color:red; font-weight:bold;'>".$row["NC_FIRST_NAME_PRI"]."</span>";
                    echo "<br/>";
