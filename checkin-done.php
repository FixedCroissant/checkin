...
//header( 'refresh: 3; url=http://localhost/apps/checkin/index.php' );
...
$result=$statement_check->get_result();
...
if($row_count>=1){
    ...
    header('Location: http://localhost/apps/checkin/erroruserinsystem.php');
...
/*
$subject="Received Request for Cooperative Education";
$body="Dear ". $name.",". "\r\n \r\n"."";
$body .="\r\n";
$body .="\r\n";
...
$body .="\r\n";
$body .="\r\n";
$body .="NC State University Housing";
$body .="\r\n";
$body .="1112 Pullen Hall";
$body .="\r\n";
$body .="Raleigh,NC 27695";

$headers = "From: University Housing <housing@ncsu.edu> \r\n";
$headers .= "Reply-To: University Housing <housing@ncsu.edu> \r\n";

//Testing Purposes
//$additional_person ="jjwill10@ncsu.edu";

//Give the e-mail provided by the SHIB log-in
$additional_person = $_SERVER['SHIB_EPPN'];

//EMail Student person filling out the form.

//Send to Student.
mail($student_email_address,$subject,$body,$headers);

//Send to Person that Filled out the Form.
mail($additional_person,$subject,$body,$headers);*/
?>
<!DOCTYPE html>
