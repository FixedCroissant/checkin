...
Description: 
THIS FILE IS SPECIFICALLY FOR FRATERNITY & SORORITY LIFE, NOT FOR GENERAL HOUSING INFORMATION. 
A way where incoming NC State Students will have the ability to swipe their user ID and our housing staff can read their information and 
...
All of this information is then kept on our housing db for report generation, on the overview_FSL.php page and the report.php pages.
-->
...
<html lang="en">
  <head>
    ...
    <title>NC State University - Housing - Check-In - FSL</title>
    <!--Fav Icon Set-->
  ...
  <body onload="display_ct(); getIDNeeded();">
          ...
          <div class="container-fluid">
              ...
              <div id="header">
                  <!--Updated 06 01 2015 for use with FSL logo-->
                  <img class="img-responsive" src="../images/fsl-text-logo-nw.png" alt="Fraternity & Sorority Life">
              </div> 
              
              <h2>North Carolina State University </h2>
              <h3 class="underline">Fraternity & Sorority Life Check-In</h3>
           ...
           <div class="row">
            ...
            <!--The student information will still go to the same database table as the general housing-->
                ...
                <div id="form_controls">
                          <div class="row">
                              <!--Line Break--> 
                                    ...
                                    <div class="col-sm-3"><!--Temporary link to Dashboard--><a href='../overview_FSL.php?dateREQUESTED=allDATES' title='Link to Dashboard'><img src="../images/dashboard_icon.png"  onmouseover="this.src='../images/dashboard_icon_red.png'" onmouseout="this.src='../images/dashboard_icon.png'" ></img></a></div>
                          </div>
                </div>
          <!--End Form Controls -->
          </form>            
