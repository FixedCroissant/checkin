...
//BROSWER REDIRECTS MUST BE COMPLETE URLs.
...
$residence_manual_add=$_REQUEST["add_student_building"];
$residence_room=$_REQUEST["searched_residence_room"];

//Residence Group
$residenceGROUP=setResidenceGroup($residence_manual_add);

//Set Residence's Campus area;
$residence_campus_area = setCampusArea($residence_manual_add);
...
$student_signedin_firstname_manual_addition = mysqli_real_escape_string($mysqli,$_REQUEST["add_student_fname"]);

//$student_signedin_lastname = $_REQUEST["searched_residence_lname"];
//Get student's last name.
$student_signedin_lastname_manual_addition=  mysqli_escape_string($mysqli,$_REQUEST["add_student_lname"]);

//Room Number set by the individual manually adding the person to the system.
$residence_room = mysqli_escape_string($mysqli,$_REQUEST["add_student_room_number"]);

//Get Student's Gender
//$studentgender = mysqli_escape_string($mysqli,$_REQUEST["searched_residence_gender"]);

$studentgender="Manually Addition"; //temporarily setting manually added students to the system as having manual_addition information


//Get Student's Classification
//$studentclassification = mysqli_escape_string($mysqli,$_REQUEST["searched_residence_classification"]);

$studentclassification = "Manually Addition";    //temporarily setting all manually added students to be "manually added"; although this may change.

//Cardswipe
$student_ID_Number_manually_added = $_REQUEST["add_student_student_ID"];
//Today's Date
$today = date("Y-m-d");
//Today's Time
...
//$cellphone_new_manually_added=preg_replace('/\D+/', '',$_REQUEST["cellphone_new"]);

$cellphone_new_manually_added="-";          //This person will be manually added to the system, thus there will be no way of checking their phone number as to what is in the current SIS record.

//echo "<p>";
//echo "Today's Date:".$today;
//echo "<br/>";
//Student ID from manual entry.
//echo "The CardSwipe".$student_ID_Number_manually_added;
//echo "<br/>";
...
//echo "<br/>";
//echo "The person's first name is:".$student_signedin_firstname_manual_addition;
//echo "<br/>";
//echo "The person's last name is".$student_signedin_lastname_manual_addition;
//echo "<br/>";
//echo "The building person is staying in:".$residence_manual_add;
//echo "<br/>";
//echo "The room the person is staying in:".$residence_room;
//echo "<br/>";
//echo "The resident group the person is staying in is:".$residenceGROUP;
//echo "<br/>";
//echo "The resident campus group the person is staying in is:".$residence_campus_area;
//echo "</p>";
...
//CHANGE HAPPENS ON 06 08 2015

$sql="INSERT INTO welcome_week_signup (residence_campus_area,residence_group,residence,residence_room,resident_fname,resident_lname,gender,classification,cardswipe,date_of_swipe,time_of_swipe,cellphone_new) VALUES ('$residence_campus_area','$residenceGROUP','$residence_manual_add','$residence_room','$student_signedin_firstname_manual_addition','$student_signedin_lastname_manual_addition','$studentgender','$studentclassification','$student_ID_Number_manually_added', '$today','$time','$cellphone_new_manually_added')";
...
//MySqli Insert Query
//CHANGE HAPPENS ON  06 08 2015
//TEMPORARILY COMMENT OUT AS ARE TESTING
...
/**********
 * TUESDAY 06 09 2015, COMMENTED OUT WHILE I TEST THE UPDATE FUNCTION
 **
...
//Update:06 09 2015 -- given the movement of the processing files to be in their separate directory, called processing, we have to go back a directory to get the 'check_actual_record' file.
//Old, now commented out.
//include('update/check_actual_record.php');
//New, should still check Date1 in SIS and provide that date with the date given in the mySQL database table called, 'welcome_week_signup'.
include('../update/check_actual_record.php');
 ...
 */ //See line: 373. This is not being used currently, as it's being kept away. End update check 'DATE_1' early arrival check. //
